...
class _DeviceInfoState extends State<DeviceInfo> {
  ...
  writeCharacteristic(String address, String serviceID, String charID,
    ...
    int dcmode_int = true ? 1 : 0;
    Uint8List boop = Uint8List.fromList(data);
    try {
      print(boop);
      await WinBle.write(
          address: address,
    ...
    _characteristicValueStream =
      ...
      setState(() {
        ...
        listValue.forEach((listItem) {
          ...
          //example ['text1', 'text2']
            byteArrayString += "0X";
            intArrayString += (listItem.toString() + ", ");
            byteArrayString += (listItem.toRadixString(16) + ", ");
            byteArrayString = byteArrayString.toUpperCase();
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            kHeadingText("Subscription Response: " + intArrayString),
            kHeadingText("Subscription Response HEX: " + byteArrayString),
              ...
              children: [
                ...
                kButton("Write Characteristics", () {
                  ...
                  writeCharacteristic(device.address, serviceTxt.text,
                      characteristicTxt.text, data, false);
                }, enabled: connected),
              ],
            ),
